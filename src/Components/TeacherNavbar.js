        ...
        >
          ...
          <div style={{backgroundColor: "#6C244C", color: "white", width: "50px", height: "50px",textAlign: "center"}} 
                                  ...
                                  {teacher ? (
                                        ...
                                        <h1 style={{alignSelf: "center", }}>{teacher.name.charAt(0)}</h1> 
            ...
            {teacher && (
              ...
              <p className="m-0"><span style={{fontFamily: 'Montserrat, sans-serif', fontWeight: "bold"}}>{teacher.name}</span></p>
              <p style={{color: "crimson"}} className="m-0">{teacher.email}</p>
            </div>
            )}
