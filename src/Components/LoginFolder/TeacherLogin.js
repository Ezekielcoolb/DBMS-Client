...
const TeacherSignIn = () => {
    ...
    const [formData, setFormData] = useState({
      ...
      const handleSignIn = async (e) => {
        e.preventDefault();
        try {
         const response = await axios.post('https://dbmsc-server.onrender.com/api/teacherSignIn', formData);
          console.log('Sign-in successful');
          localStorage.setItem("TeacherUser", JSON.stringify(formData))
          ...
          <LoginRap>
            <div style={{width: "100%", alignItems: "center", }} className='d-flex justify-content-between sign-block'>
              ...
              <div className='d-flex justify-content-center' style={{
                  backgroundImage: `url("/images/teacher1.jpg")`,
              ...
              <div style={{width:"40%"}} className='d-flex justify-content-around sign-pic2'>
                <div className='card d-flex justify-content-center' style={{alignItems: "center", height: "100vh", width: "100%"}}>
                  <div style={{alignSelf: 'center', width: "100%"}}>
                    ...
                    <h3 className='m-0' style={{fontWeight: "bold"}} >Welcome Back</h3>
                    <p >Your effort is well recorgnized!</p>
